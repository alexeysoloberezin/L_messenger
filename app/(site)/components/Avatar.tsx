          ...
          {users.slice(0, 2).map(el => (
            el?.image ? (
              <div key={el.id} className="relative">
                <Image width={40} height={40} className="w-10 h-10 border-2 border-white rounded-full dark:border-gray-600"
                     src={el.image} alt=""
                />
              ...
              <svg key={el.id} className="w-9 h-9 text-gray-400 border-2 rounded-full dark:border-gray-600 bg-gray-800"
